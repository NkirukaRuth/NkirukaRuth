# 👋 Hi, I'm Anukam Nkiruka Ruth!

![Github](https://github.com/user-attachments/assets/7acb399b-0e36-4e43-99dc-f842d1f8d8c3)

## 🌐🧩 Data Analyst | 📊 Power BI Expert | 🛠 SQL Specialist | 📈 Data Storyteller | 🔍IT Support Specialist | ✍ Tech Blogger
...
With a background in Economics, I transitioned into the tech industry, leveraging my analytical skills to help businesses adopt data-driven solutions that enhance efficiency and innovation with CRM Software such as **Go Highlevel**, and **HubSpot**
...
✅ Data Visualization: Creating Dashboard and Reporting with clear narrative

✅Data Analysis: Data exploration, cleaning, aggregation, and Business Insight

✅ IT Support Specialist: Proficiency in the use CRM software(GoHighLevel, HubSpot), Zapier, Appointment Setting professional

✅ Lead Generation: Use of (LinkedIn sales Navigator, Apollo.oi) for Valid lead.

✅ SQL Development: Writing optimized queries for data extraction and transformation.
...
![Workflow Automation](https://img.shields.io/badge/Workflow%20Automation-E25A1C?style=for-the-badge\&logo=Workflow%20Automation\&logoColor=white)
...
-([https://chiasauka.hashnode.dev/the-role-of-excel-in-tracking-industry-competitor-performance](https://chiasauka.hashnode.dev/the-role-of-excel-in-tracking-industry-competitor-performance)) - Hashnode

<!-- BLOG-POST-LIST:END -->

➡ [Read more on Chiasauka Data Dive Hub](https://chiasauka.hashnode.dev/)
...
* 🔍 Freelance or Contract project data analytics – Need help designing a scalable data Visualization? Let's build it!
* 📈 Business Intelligence & Analytics – Need insights from data? Let’s uncover key trends together!
* 💻 Workflow Automations – Automating software for seamless workflow? Let’s work on it!
* 🎓 Continuous Learning and Tech growth? Let’s connect!

📧 Email: [anukamnkirukaruth@gmail.com](mailto:anukamnkirukaruth@gmail.com)
🌍 LinkedIn: [Anukam Nkiruka Ruth](https://www.linkedin.com/in/anukam-ruth-nkiruka-99157a168/)
✍ Blog: [Chiasauka Data Dive Hub](https://chiasauka.hashnode.dev/)

---

## ⭐ Let's turn data into impactful insights, drive innovation througha Ai technologies and Automate seamless workflow!

\#DataAnalysis #DataVisualization #Tech-savvy #PowerBI #SQL #AI  #WorkflowAutomation #ITSupportSpecialist

© 2025 Anukam Nkiruka Ruth
